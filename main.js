...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const collectionLink = collectionDropdown.querySelector('a');
    collectionLink.addEventListener('click', function(e) {
        e.preventDefault(); // Prevent the default link behavior (scrolling to top)
        collectionDropdown.classList.toggle('active'); // Toggle the 'active' class to show/hide the dropdown
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // document.addEventListener('DOMContentLoaded', function() {
    // const collectionLink = document.querySelector('.collection-dropdown a');
    // const dropdown = document.querySelector('.dropdown');
    // // Assuming the dropdown is hidden by default (e.g., via CSS: .dropdown { display: none; })
    // collectionLink.addEventListener('click', function(e) {
    //     e.preventDefault(); // Prevent the default link behavior (scrolling to top)
